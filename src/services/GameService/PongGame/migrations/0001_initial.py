# Generated by Django 3.2.5 on 2024-09-20 12:43
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('party_name', models.CharField(default='game', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gameMode', models.CharField(default='ffa', max_length=20)),
                ('players', models.ManyToManyField(to='PongGame.PongPlayer')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('game', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='party', to='PongGame.game')),
                ('next_match', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='previous_matches', to='PongGame.match')),
                ('tournament', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='PongGame.tournament')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('game', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='PongGame.game')),
                ('player', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
