# Generated by Django 3.2.5 on 2024-06-24 18:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('player', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='PongGame.player')),
            ],
        ),
        migrations.CreateModel(
            name='PongPlayer',
        ...
        migrations.AddField(
            model_name='game',
            name='players',
            field=models.ManyToManyField(to='PongGame.Player'),
        ),
    ]
